...
">
    <div class="email-card"
        ...
        <div class="section-one">
            ...
            <h2>
                Hi {{ $firstName }},<br />
                <p style="font-size:1.1rem">You have a new update on {{ $projectName }} project</p>
        ...
        <div class="section-two">
            ...
            <p style="font-size:1.1rem">Below is new project details</p>

            @foreach ($details as $detail)
                <p style="font-size:0.8rem"><b>{{ $detail }}</b></p>
            @endforeach
