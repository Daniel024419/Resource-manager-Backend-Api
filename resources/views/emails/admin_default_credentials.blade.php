    ...
    <div class="email-card"
        ...
        <div class="section-two">
            <p style="font-size:1.2rem">
                ...
                An admin account was setup for you , All you need to do is set up a new password and update your profile
                to get started.
                <hr>
            </p>

            <p> Below is your defult credentails</p>
            <h2>Email : {{ $email }}</h1>

            <h2>Password : {{ $password }}</h1>
